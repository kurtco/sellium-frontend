...
export enum SnackBarLabels {
  ...
  licenseAndTrainingSuccess = "Agent  license and training  updated successfully",
  licenseAndTrainingError = "Couldn't Update the agent license and training information . Try again.",
}
